...
namespace LibPff.Interop
{
    internal sealed class NativeAdapterWin64 : INativeAdapter
    {
        ...
        {
            return NativeWin64.FileGetNumberOfUnallocatedBlocks(file, unallocated_block_type, out number_of_unallocated_blocks, out error);
        }
        ...
        {
            return NativeWin64.FolderGetSubFolderByUtf8Name(folder, utf8_sub_folder_name, utf8_sub_folder_name_size, out sub_folder, out error);
        }
        ...
        {
            return NativeWin64.FolderGetSubFolderByUtf16Name(folder, utf16_sub_folder_name, utf16_sub_folder_name_size, out sub_folder, out error);
        }
        public int FolderGetSubFolders(IntPtr item, out IntPtr sub_folders, out IntPtr error)
        {
            return NativeWin64.FolderGetSubFolders(item, out sub_folders, out error);
        }
        public int FolderGetNumberOfSubMessages(IntPtr folder, out int number_of_sub_messages, out IntPtr error)
        {
            return NativeWin64.FolderGetNumberOfSubMessages(folder, out number_of_sub_messages, out error);
        }
        public int FolderGetSubMessage(IntPtr folder, int sub_message_index, out IntPtr sub_message, out IntPtr error)
        {
            return NativeWin64.FolderGetSubMessage(folder, sub_message_index, out sub_message, out error);
        }
        ...
        {
            return NativeWin64.FolderGetSubMessageByUtf8Name(folder, utf8_sub_message_name, utf8_sub_message_name_size, out sub_message, out error);
        }
        ...
        {
            return NativeWin64.FolderGetSubMessageByUtf16Name(folder, utf16_sub_message_name, utf16_sub_message_name_size, out sub_message, out error);
        }
        public int FolderGetSubMessages(IntPtr item, out IntPtr sub_messages, out IntPtr error)
        {
            return NativeWin64.FolderGetSubMessages(item, out sub_messages, out error);
        }
        ...
        {
            return NativeWin64.FolderGetNumberOfSubAssociatedContents(folder, out number_of_sub_associated_contents, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryType(item, set_index, entry_index, out entry_type, out value_type, out name_to_id_map_entry, out error);
        }
        public int ItemGetValueType(IntPtr item, int set_index, uint entry_type, out uint value_type, byte flags, out IntPtr error)
        {
            return NativeWin64.ItemGetValueType(item, set_index, entry_type, out value_type, flags, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValue(item, set_index, entry_type, out value_type, out value_data, out value_data_size, flags, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValueByUtf8Name(item, set_index, utf8_entry_name, utf8_entry_name_length, out value_type, out value_data, out value_data_size, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValueByUtf16Name(item, set_index, utf16_entry_name, utf16_entry_name_length, out value_type, out value_data, out value_data_size, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValueBoolean(item, set_index, entry_type, out entry_value, flags, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValueBooleanByUtf8Name(item, set_index, utf8_entry_name, utf8_entry_name_length, out entry_value, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValueBooleanByUtf16Name(item, set_index, utf16_entry_name, utf16_entry_name_length, out entry_value, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValue16bit(item, set_index, entry_type, out entry_value, flags, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValue16bitByUtf8Name(item, set_index, utf8_entry_name, utf8_entry_name_length, out entry_value, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValue16bitByUtf16Name(item, set_index, utf16_entry_name, utf16_entry_name_length, out entry_value, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValue32bit(item, set_index, entry_type, out entry_value, flags, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValue32bitByUtf8Name(item, set_index, utf8_entry_name, utf8_entry_name_length, out entry_value, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValue32bitByUtf16Name(item, set_index, utf16_entry_name, utf16_entry_name_length, out entry_value, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValue64bit(item, set_index, entry_type, out entry_value, flags, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValue64bitByUtf8Name(item, set_index, utf8_entry_name, utf8_entry_name_length, out entry_value, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValue64bitByUtf16Name(item, set_index, utf16_entry_name, utf16_entry_name_length, out entry_value, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValueFiletime(item, set_index, entry_type, out entry_value, flags, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValueFiletimeByUtf8Name(item, set_index, utf8_entry_name, utf8_entry_name_length, out entry_value, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValueFiletimeByUtf16Name(item, set_index, utf16_entry_name, utf16_entry_name_length, out entry_value, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValueSize(item, set_index, entry_type, out entry_value, flags, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValueSizeByUtf8Name(item, set_index, utf8_entry_name, utf8_entry_name_length, out entry_value, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValueSizeByUtf16Name(item, set_index, utf16_entry_name, utf16_entry_name_length, out entry_value, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValueFloatingPoint(item, set_index, entry_type, out entry_value, flags, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValueFloatingPointByUtf8Name(item, set_index, utf8_entry_name, utf8_entry_name_length, out entry_value, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValueFloatingPointByUtf16Name(item, set_index, utf16_entry_name, utf16_entry_name_length, out entry_value, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValueUtf8StringSize(item, set_index, entry_type, out utf8_string_size, flags, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValueUtf8StringSizeByUtf8Name(item, set_index, utf8_entry_name, utf8_entry_name_length, out utf8_string_size, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValueUtf8StringSizeByUtf16Name(item, set_index, utf16_entry_name, utf16_entry_name_length, out utf8_string_size, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValueUtf8String(item, set_index, entry_type, utf8_string, utf8_string_size, flags, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValueUtf8StringByUtf8Name(item, set_index, utf8_entry_name, utf8_entry_name_length, utf8_string, utf8_string_size, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValueUtf8StringByUtf16Name(item, set_index, utf16_entry_name, utf16_entry_name_length, utf8_string, utf8_string_size, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValueUtf16StringSize(item, set_index, entry_type, out utf16_string_size, flags, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValueUtf16StringSizeByUtf8Name(item, set_index, utf8_entry_name, utf8_entry_name_length, out utf16_string_size, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValueUtf16StringSizeByUtf16Name(item, set_index, utf16_entry_name, utf16_entry_name_length, out utf16_string_size, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValueUtf16String(item, set_index, entry_type, utf16_string, utf16_string_size, flags, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValueUtf16StringByUtf8Name(item, set_index, utf8_entry_name, utf8_entry_name_length, utf16_string, utf16_string_size, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValueUtf16StringByUtf16Name(item, set_index, utf16_entry_name, utf16_entry_name_length, utf16_string, utf16_string_size, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValueBinaryDataSize(item, set_index, entry_type, out binary_data_size, flags, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValueBinaryDataSizeByUtf8Name(item, set_index, utf8_entry_name, utf8_entry_name_length, out binary_data_size, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValueBinaryDataSizeByUtf16Name(item, set_index, utf16_entry_name, utf16_entry_name_length, out binary_data_size, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValueBinaryData(item, set_index, entry_type, binary_data, binary_data_size, flags, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValueBinaryDataByUtf8Name(item, set_index, utf8_entry_name, utf8_entry_name_length, binary_data, binary_data_size, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValueBinaryDataByUtf16Name(item, set_index, utf16_entry_name, utf16_entry_name_length, binary_data, binary_data_size, out error);
        }
        ...
        {
            return NativeWin64.ItemGetEntryValueGuid(item, set_index, entry_type, guid, guid_size, flags, out error);
        }
        ...
        {
            return NativeWin64.RecordEntryGetValueUtf16String(record_entry, utf16_string, utf16_string_size, out error);
        }
        ...
        {
            return NativeWin64.MessageGetEntryValueUtf8StringSize(message, entry_type, out utf8_string_size, out error);
        }
        ...
        {
            return NativeWin64.MessageGetEntryValueUtf8String(message, entry_type, utf8_string, utf8_string_size, out error);
        }
        ...
        {
            return NativeWin64.MessageGetEntryValueUtf16StringSize(message, entry_type, out utf16_string_size, out error);
        }
        ...
        {
            return NativeWin64.MultiValueGetValue(multi_value, value_index, out value_type, out value_data, out value_data_size, out error);
        }
        public int MultiValueGetValue32bit(IntPtr multi_value, int value_index, out uint value, out IntPtr error)
        {
            return NativeWin64.MultiValueGetValue32bit(multi_value, value_index, out value, out error);
        }
        public int MultiValueGetValue64bit(IntPtr multi_value, int value_index, out ulong value, out IntPtr error)
        {
            return NativeWin64.MultiValueGetValue64bit(multi_value, value_index, out value, out error);
        }
        public int MultiValueGetValueFiletime(IntPtr multi_value, int value_index, out ulong filetime, out IntPtr error)
        {
            return NativeWin64.MultiValueGetValueFiletime(multi_value, value_index, out filetime, out error);
        }
        ...
        {
            return NativeWin64.MultiValueGetValueUtf8StringSize(multi_value, value_index, out utf8_string_size, out error);
        }
        ...
        {
            return NativeWin64.MultiValueGetValueUtf8String(multi_value, value_index, utf8_string, utf8_string_size, out error);
        }
        ...
        {
            return NativeWin64.MultiValueGetValueUtf16StringSize(multi_value, value_index, out utf16_string_size, out error);
        }
        ...
        {
            return NativeWin64.MultiValueGetValueUtf16String(multi_value, value_index, utf16_string, utf16_string_size, out error);
        }
        public int MultiValueGetValueBinaryDataSize(IntPtr multi_value, int value_index, out UIntPtr size, out IntPtr error)
        {
            return NativeWin64.MultiValueGetValueBinaryDataSize(multi_value, value_index, out size, out error);
        }
        ...
        {
            return NativeWin64.MultiValueGetValueBinaryData(multi_value, value_index, binary_data, size, out error);
        }
        public int MultiValueGetValueGuid(IntPtr multi_value, int value_index, byte[] guid, UIntPtr size, out IntPtr error)
        {
            return NativeWin64.MultiValueGetValueGuid(multi_value, value_index, guid, size, out error);
        }
        public int NameToIdMapEntryGetType(IntPtr name_to_id_map_entry, out byte entry_type, out IntPtr error)
        {
            return NativeWin64.NameToIdMapEntryGetType(name_to_id_map_entry, out entry_type, out error);
        }
        public int NameToIdMapEntryGetNumber(IntPtr name_to_id_map_entry, out uint number, out IntPtr error)
        {
            return NativeWin64.NameToIdMapEntryGetNumber(name_to_id_map_entry, out number, out error);
        }
        public int NameToIdMapEntryGetUtf8StringSize(IntPtr name_to_id_map_entry, out UIntPtr utf8_string_size, out IntPtr error)
        {
            return NativeWin64.NameToIdMapEntryGetUtf8StringSize(name_to_id_map_entry, out utf8_string_size, out error);
        }
        ...
        {
            return NativeWin64.NameToIdMapEntryGetUtf8String(name_to_id_map_entry, utf8_string, utf8_string_size, out error);
        }
        public int NameToIdMapEntryGetUtf16StringSize(IntPtr name_to_id_map_entry, out UIntPtr utf16_string_size, out IntPtr error)
        {
            return NativeWin64.NameToIdMapEntryGetUtf16StringSize(name_to_id_map_entry, out utf16_string_size, out error);
        }
        ...
        {
            return NativeWin64.RecordEntryGetDataAsUtf16String(record_entry, utf16_string, utf16_string_size, out error);
        }
        public int RecordEntryGetDataAsGuid(IntPtr record_entry, byte[] gui_data, UIntPtr guid_data_size, out IntPtr error)
        {
            return NativeWin64.RecordEntryGetDataAsGuid(record_entry, gui_data, guid_data_size, out error);
        }
        public int RecordEntryGetMultiValue(IntPtr record_entry, out IntPtr multi_value, out IntPtr error)
        {
            return NativeWin64.RecordEntryGetMultiValue(record_entry, out multi_value, out error);
        }
        public long RecordEntryReadBuffer(IntPtr record_entry, byte[] buffer, UIntPtr buffer_size, out IntPtr error)
        {
            return NativeWin64.RecordEntryReadBuffer(record_entry, buffer, buffer_size, out error);
        }
        public long RecordEntrySeekOffset(IntPtr record_entry, long offset, int whence, out IntPtr error)
        {
            return NativeWin64.RecordEntrySeekOffset(record_entry, offset, whence, out error);
        }
        public int RecordSetFree(out IntPtr record_set, out IntPtr error)
        {
            return NativeWin64.RecordSetFree(out record_set, out error);
        }
        public int RecordSetGetNumberOfEntries(IntPtr record_set, out int number_of_entries, out IntPtr error)
        {
            return NativeWin64.RecordSetGetNumberOfEntries(record_set, out number_of_entries, out error);
        }
        public int RecordSetGetEntryByIndex(IntPtr record_set, int entry_index, out IntPtr record_entry, out IntPtr error)
        {
            return NativeWin64.RecordSetGetEntryByIndex(record_set, entry_index, out record_entry, out error);
        }
        ...
        {
            return NativeWin64.RecordSetGetEntryByType(record_set, entry_type, value_type, out record_entry, flags, out error);
        }
        ...
        {
            return NativeWin64.RecordSetGetEntryByUtf8Name(record_set, utf8_string, utf8_string_length, value_type, out record_entry, flags, out error);
        }
        ...
        {
            return NativeWin64.RecordSetGetEntryByUtf16Name(record_set, utf16_string, utf16_string_length, value_type, out record_entry, flags, out error);
        }
        public int GetAccessFlagsRead()
        {
            return NativeWin64.GetAccessFlagsRead();
        }
        public int GetCodepage(out int codepage, out IntPtr error)
        {
            return NativeWin64.GetCodepage(out codepage, out error);
        }
        public int SetCodepage(int codepage, out IntPtr error)
        {
            return NativeWin64.SetCodepage(codepage, out error);
        }
        public int CheckFileSignature([MarshalAs(UnmanagedType.LPStr)] string filename, out IntPtr error)
        {
            return NativeWin64.CheckFileSignature(filename, out error);
        }
        public int CheckFileSignatureWide([MarshalAs(UnmanagedType.LPWStr)] string filename, out IntPtr error)
        {
            return NativeWin64.CheckFileSignatureWide(filename, out error);
        }
        public int CheckFileSignatureFileIoHandle(IntPtr file_io_handle, out IntPtr error)
        {
            return NativeWin64.CheckFileSignatureFileIoHandle(file_io_handle, out error);
        }
    }
}